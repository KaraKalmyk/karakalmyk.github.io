...
<article class="page-content">
  <header class="page-header">
    <h1 class="page-title">{{ t.nav.ustnye_predaniya | default: "ustnye-predaniya" }}</h1>
  ...
  <div class="prose">
    ...
    <p><a href="/pages/ustnye-predaniya.html">View Russian version →</a></p>
  </div>
</article>
