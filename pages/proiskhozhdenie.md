...
- **Смешанное происхождение.** Некоторые исследователи XIX века полагали, что предками сарт-калмыков были мужчины-узбеки и кыргызы, которые взяли в жены женщин из ойратского племени олётов, живших в районе Текеса (современный Китай).
...
У сарт-калмыков, как и у их соседей-кыргызов, существует строгий запрет на браки между родственниками до седьмого колена. Этот принцип коллективной ответственности и родовой памяти называется «долан эчкъ» («семь отцов»). Интересно, что это, вероятно, прямой перевод кыргызского выражения «жеты ата», так как у других калмыков и ойратов используется термин «долан үй» («семь поколений»). Это яркий пример культурного взаимопроникновения двух народов.
